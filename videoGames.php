    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <form action="results.php" method="get">
          Search By Title <input type="text" name="gameTitle"><input type="submit" value="Search" name="gSearchBtn" onclick="loading()">
          <span style="color:red;position:absolute;"><?php echo $_SESSION['blank'] ?></span><span style="font-size: 30px; color: green;" id="load2"><?php echo 'Searching Please Wait'; ?><img id="load" style="height:80px; width:80px;"  src="loading.gif"></span>
        </form>
      </div>
    </div>
  </div>
...
var a = document.getElementById("load2");
